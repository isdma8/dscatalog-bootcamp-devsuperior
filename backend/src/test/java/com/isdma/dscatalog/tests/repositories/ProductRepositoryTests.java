...
@DataJpaTest // so vai carregar os componentes necessarios para rodar o teste, nao vai ficar
				// chamndo o contexto da aplicação servidor web, como é um repository so precisa
				// destes componentes
...
public class ProductRepositoryTests {
	...
	void setUp() throws Exception {
		...
		countCategory3Products = 23L; //ja sei isso pela instancia do banco la
	...
	public void saveShouldPersistWithAutoIncrementWhenIdIsNull() {
		...
		Assertions.assertSame(result.get(), product); // acessar objeto product dentro do optional fazemos com o get
														// //usamos este para ver se objetos tem a mesma referencia ou
														// seja se sao o mesmo, ou seja vemos assim se sao o mesmo
														// objeto o que criamos e o que fomos buscar
	}
	...
	public void deleteShouldDeleteObjectWhenIdExists() {
		...
		// retorna sempre um optional mas depois o optinal tem o metodo ispresent para
		// sabermos se de facto tem algum objeto
