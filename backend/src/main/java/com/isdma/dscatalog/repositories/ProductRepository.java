...
public interface ProductRepository extends JpaRepository<Product, Long>{
	...
	@Query("SELECT DISTINCT obj FROM Product obj INNER JOIN obj.categories cats " //Se nao metermos distinct pode haver repetição de produtos quandos buscamos todos porque podem pertencer a mai que uma categoria ja que se trata de muitos para muitos
