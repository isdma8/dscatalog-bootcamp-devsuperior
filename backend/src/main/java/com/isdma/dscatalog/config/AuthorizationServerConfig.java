...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory()
		.withClient("dscatalog") //frontend tem de informar destes dados da aplicação no token para ter acesso
		.secret(passwordEncoder.encode("dscatalog123"))    //mais tarde iremos colocar em arquivo	
		...
		.accessTokenValiditySeconds(86400); //1 dia em segundos em que o tokin é valido
	}
