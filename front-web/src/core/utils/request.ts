...
const BASE_URL = process.env.REACT_APP_BACKEND_URL ?? 'http://localhost:8090'; //'http://localhost:3000';//ja nao preciso usar o proxy, podia colocar aqui direto o link do backend porque ja configurei o CORS no backend qu resolve esse problema
